    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="relative w-[14.88%] h-[9.30%] cursor-pointer transition-all duration-500 active:scale-98 group"
                data-gtm="mood-light-button"
                style={{ filter: 'drop-shadow(0 6px 12px rgba(0,0,0,0.25))' }}
            >
                {/* 받침대 (하단 - 원형 베이스) */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[13.02%] h-[0.70%] bg-gradient-to-b from-[#2C2C2C] to-[#1A1A1A] rounded-full"
                    style={{
                ...
                {/* 스탠드 (긴 검은색 기둥) */}
                <div className="absolute bottom-[0.70%] left-1/2 -translate-x-1/2 w-[1.40%] h-[7.44%] bg-gradient-to-r from-[#2C2C2C] via-[#3A3A3A] to-[#2C2C2C] rounded-full"
                    style={{
                ...
                {/* 상단 연결부 */}
                <div className="absolute top-[0.70%] left-1/2 -translate-x-1/2 w-[2.79%] h-[0.70%] bg-gradient-to-b from-[#3A3A3A] to-[#2C2C2C] rounded-full"
                    style={{
                ...
                >
                    ...
                    >
                        ...
                        {/* 갓 내부 빛 반사 */}
                        <div className={`absolute top-[0.93%] left-1/2 -translate-x-1/2 w-[9.30%] h-[1.40%] rounded-full blur-sm transition-opacity duration-700 ${
                ...
                {/* 전구 내부 (갓 속 - 빛나는 코어) */}
                <div className={`absolute top-[0.47%] left-1/2 -translate-x-1/2 w-[6.51%] h-[1.63%] rounded-full transition-all duration-700 ${
                    moodLightOn
                ...
                {moodLightOn && (
                    <>
                        {/* 상단 빛 확산 (천장 방향) */}
                        <div className="absolute -top-[4.65%] left-1/2 -translate-x-1/2 w-[37.21%] h-[9.30%] bg-yellow-200 rounded-full blur-3xl opacity-30 -z-10 animate-pulse pointer-events-none"
                            style={{ animationDuration: '3s' }}
                        ></div>
                        <div className="absolute -top-[2.33%] left-1/2 -translate-x-1/2 w-[29.77%] h-[7.44%] bg-yellow-100 rounded-full blur-2xl opacity-40 -z-10 animate-pulse pointer-events-none"
                            style={{ animationDuration: '2.5s' }}
                        ></div>

                        {/* 하단 빛 확산 (바닥 방향) */}
                        <div className="absolute -bottom-[1.86%] left-1/2 -translate-x-1/2 w-[26.05%] h-[2.79%] bg-yellow-200 rounded-full blur-2xl opacity-25 -z-10 pointer-events-none"
                            style={{
                        ...
                        {/* 주변 앰비언트 글로우 */}
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[44.65%] h-[11.16%] bg-yellow-50 rounded-full blur-3xl opacity-20 -z-20 pointer-events-none"></div>
                    </>
                )}
