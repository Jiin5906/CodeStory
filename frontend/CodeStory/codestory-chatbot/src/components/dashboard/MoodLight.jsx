    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-14 h-14"
                    style={{
                ...
                >
                    ...
                    >
                        ...
                        {/* 갓 내부 빛 반사 */}
                        <div className={`absolute top-4 left-1/2 -translate-x-1/2 w-10 h-6 rounded-full blur-sm transition-opacity duration-700 ${
                ...
                {/* 전구 내부 (갓 속 - 빛나는 코어) */}
                <div className={`absolute top-2 left-1/2 -translate-x-1/2 w-7 h-7 rounded-full transition-all duration-700 ${
                    moodLightOn
