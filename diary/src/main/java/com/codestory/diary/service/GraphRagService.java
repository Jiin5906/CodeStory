        ...
        try {
            ...
            String promptToAnswer = """
                ...
                1. **데이터에 없는 정보는 절대 지어내지 마세요.**
                   - 아래 [User's Memory]에 없는 내용이면 "아직 관련된 이야기를 나눈 적이 없네요"라고 솔직하게 말하세요.
                ...
                위 데이터가 비어있거나 관련 내용이 없다면, 솔직하게 "아직 관련된 이야기를 나눈 적이 없네요"라고 답하세요.
                ...
                3. **정보가 없다면:** 솔직하게 "아직 관련된 이야기를 나눈 적이 없네요"라고 말하세요.
    ...
    private String fallbackGraphSearch(Long userId, String question) {
        try {
            ...
            String promptToAnswer = """
                ...
                아래 [User's Memory]에 관련 내용이 없다면, "아직 관련된 이야기를 나눈 적이 없네요"라고 솔직하게 말하세요.
